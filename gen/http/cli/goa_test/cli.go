...
//
// goa_test HTTP client CLI support package
//
// Command:
...
import (
	"flag"
	"fmt"
	calcc "goa_test/gen/http/calc/client"
	"net/http"
	"os"
...
func UsageExamples() string {
	return os.Args[0] + ` calc multiply --a 4186952310940263063 --b 6239305883821146754` + "\n" +
		""
}
...
Example:
    %[1]s calc multiply --a 4186952310940263063 --b 6239305883821146754
`, os.Args[0])
}
